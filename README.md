...
In this project, we explore the specific case of total decommercialization of healing gatherings in the spirit of UO, which we'll refer to as TDSUO.

We first make our claims:

- We do not claim that TDSUO is 'good', or that it should be implemented. 
- We do claim that TDSUO could have great potential for collective healing.
- We also claim that TDSUO is a concept worthy of research. That is is worthy of discussion and to be experimented with (practical experience is needed in order to understand the concept).

Then we describe what the project aims for:

- To describe the relation of current events to UO.
- To provide a comprehensive basis of knowledge and insights so TDSUO can be more easily discussed on a deeper level.
- To provide a framework for organizers interested in TDSUO, allowing them to start organizing in this way and gain new insights.
